            ...
            <div class="modal-content">
                ...
                <div class="modal-body">          
                    <div class="row  appointment-details-container" id="data_for_edit">
                        <div class="col-md-12 mb-3"><span class="bg-secondary btn-block text-white">Appointment Details</span></div>
                        <div class="col-md-4">
                    ...
                    <div class="row  illness-container">
                        <div class="col-md-12"><span class="bg-secondary btn-block text-white">Symptoms for the last 24 hours *</span></div>

                        <?php foreach($illnesses as $row): ?>
                        <div class="col-md-6 mt-3">
                            <div class="checkbox" title="<?= $row->description ?>"><label><input type="checkbox" title="<?= $row->description ?>" name="<?= $row->illness ?>" value="<?= $row->illness ?>"> <?= $row->illness ?></label></div>
                        </div>
                        <?php endforeach; ?>
                        <div class="col-md-12 mt-3">
                            <div class="form-group form-group-default">
                                <label><span class="text-danger">*</span> Other/s</label>
                                <textarea name="other_illness" id="other_illness" class="form-control" cols="30" rows="2" placeholder="How do you feel today?"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <hr>
                        ...
                        <div class="col-md-12">
                            <div class="checkbox"><label><input type="checkbox" name="travel_history" value="travel_history"> Travel history for the last 14days outside of Iloilo Province</label></div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox"><label><input type="checkbox" name="exposure_to_covid" value="exposure_to_covid"> Exposure to suspected or confirmed COVID positive person (primary contact)</label></div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox"><label><input type="checkbox" name="contact_to_person" value="contact_to_person"> Contact to person with COVID exposure (secondary contact)</label></div>
                        </div>
                    </div>

                    <div class="row mt-3 illness-container">
                        <div class="col-md-12"><span class="bg-secondary btn-block text-white">How do you feel today? *</span></div>
                    ...
                    <div class="row  assign-doctor-container" hidden>
                        <div class="col-md-12"><span class="bg-secondary btn-block text-white">Assign Doctor</span></div>
                    ...
                    <div class="row  patient-details-container" hidden>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                <label>Exposure to suspected or confirmed COVID positive person (primary contact)</label>
                        ...
                        <div class="col-md-12 mt-2"><span class="bg-secondary btn-block text-white">Patient Details</span></div>
                        <div class="col-md-12 mb-3"></div>
                        <div class="col-sm-4">
                            <div class="form-group form-group-default">
                    ...
                    <div class="row  assigned-doctor-container" id="data_for_edit">
                        <div class="col-md-12 mb-3"><span class="bg-secondary btn-block text-white">Assigned Doctor</span></div>
                        <div class="col-sm-6">
                            <div class="form-group form-group-default">
                                <label><span class="text-danger">*</span> Doctor</label>
                                <input  type="text" name="doctor_forview" id="doctor_forview" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group form-group-default">
                                <label><span class="text-danger">*</span> Specialization</label>
                                <input  type="text" name="specialization_forview" id="specialization_forview" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label><span class="text-danger">*</span> Doctor Remarks</label>
                                <textarea name="doctor_remarks_forview" id="doctor_remarks_forview" class="form-control" cols="30" rows="5" disabled></textarea>
                            </div>
                        </div>
                ...
                <div class="modal-footer no-bd">
                    <button type="submit" id="btnUpdate" class="btn btn-secondary" hidden><i class="fa fa-save"></i> Update</button>
                    <button type="button" id="btnssave" class="btn btn-secondary"><i class="fa fa-save"></i> Save</button>
