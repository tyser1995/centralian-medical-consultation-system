                        ...
                        <div class="col-md-12">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <button type="button" class="btn btn-success btn-sm btn-block"  style="display:block;height:30px;" onclick="document.getElementById('upload_stool').click()">Browse</button>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <button type="button" class="btn btn-success btn-sm btn-block"  style="display:block;height:30px;" onclick="document.getElementById('upload_xray').click()">Browse</button>
                            ...
                            <div class="form-group form-group-default">
                                ...
                                <textarea name="doctor_remarks" id="doctor_remarks" class="form-control" cols="30" rows="10" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
